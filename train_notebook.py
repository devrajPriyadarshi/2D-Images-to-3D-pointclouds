...
from data_loaders import parseTrainDataNotebook, parseValDataNotebook, DatasetLoader
...
if __name__ == "__main__":
    ...
    img_,mod_,ang_ = parseTrainDataNotebook()
    ...
    img_,mod_,ang_ = parseValDataNotebook()
